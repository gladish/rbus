...
static rbusOpenTelemetryContext* rbus_getOpenTelemetryContextFromTLS();
...
rbusOpenTelemetryContext*
rbus_getOpenTelemetryContextFromTLS()
{
...
{
    rbusOpenTelemetryContext* ot_ctx = rbus_getOpenTelemetryContextFromTLS();
